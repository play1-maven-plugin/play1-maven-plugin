...
public class PlayAssertTextLikeStep
    extends AbstractSeleniumStep
{
    ...
    public PlayAssertTextLikeStep( StoredVars storedVars, String param1, String param2 )
    {
    ...
    public String toString()
    {
        ...
        buf.append( "asserTextLike('" ).append( param1 ).append( "', '" ).append( param2 ).append( "')" );
        return buf.toString();
    }
