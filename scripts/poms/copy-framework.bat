...
copy %SRC_DIR%\framework\assembly-framework-resources.xml %DST_DIR%\framework\assembly-framework-resources.xml
...
copy %SRC_DIR%\modules\crud\assembly-module-resources.xml %DST_DIR%\modules\crud\assembly-module-resources.xml
...
copy %SRC_DIR%\modules\docviewer\assembly-module-resources.xml %DST_DIR%\modules\docviewer\assembly-module-resources.xml
...
copy %SRC_DIR%\modules\secure\assembly-module-resources.xml %DST_DIR%\modules\secure\assembly-module-resources.xml
...
copy %SRC_DIR%\modules\testrunner\assembly-module-resources.xml %DST_DIR%\modules\testrunner\assembly-module-resources.xml
